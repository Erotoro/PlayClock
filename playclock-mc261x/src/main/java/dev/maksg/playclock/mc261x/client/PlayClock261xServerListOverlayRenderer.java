...
public final class PlayClock261xServerListOverlayRenderer {
    ...
    private PlayClock261xServerListOverlayRenderer() {
    }

    public static void beginFrame() {
        PlayClock261xServerListOverlayState.beginFrame();
    }
    ...
    public static void renderDailyBadge(
        ...
        PlayClock261xServerListOverlayState.recordRowLayout(rowX, rowY, rowWidth, rowHeight);
        if (hovered) {
            PlayClock261xServerListOverlayState.recordHoveredTarget(target, mouseX, mouseY);
        }
    ...
    public static void renderPanels(GuiGraphicsExtractor graphics, int screenWidth, int screenHeight) {
        ...
        TrackedTarget hoveredTarget = PlayClock261xServerListOverlayState.hoveredTarget();
        ...
        TooltipLayout tooltip = TooltipLayout.anchoredBelow(
                screenWidth,
                screenHeight,
                PlayClock261xServerListOverlayState.hoveredMouseX() + 12,
                PlayClock261xServerListOverlayState.hoveredMouseY() - 10,
                DETAIL_WIDTH,
                DETAIL_HEIGHT);
    ...
    private static void renderHeaderSummary(
        ...
        String label = safeText(PlayClock261xLocalization.string(PlayClockTranslationKeys.LABEL_TOTAL_PLAYED_ON_SERVERS)) + ": ";
