...
public final class PlayClock12111WorldListOverlayRenderer {
    ...
    private PlayClock12111WorldListOverlayRenderer() {
    }

    public static void beginFrame() {
        PlayClock12111WorldListOverlayState.beginFrame();
    }
    ...
    public static void renderDailyBadge(
        ...
        PlayClock12111WorldListOverlayState.recordRowLayout(rowX, rowY, rowWidth, rowHeight);
        if (hovered) {
            PlayClock12111WorldListOverlayState.recordHoveredTarget(target, mouseX, mouseY);
        }
    ...
    public static void renderPanels(DrawContext context, int screenWidth, int screenHeight) {
        ...
        TrackedTarget hoveredTarget = PlayClock12111WorldListOverlayState.hoveredTarget();
        ...
        TooltipLayout tooltip = TooltipLayout.anchoredBelow(
                screenWidth,
                screenHeight,
                PlayClock12111WorldListOverlayState.hoveredMouseX() + 12,
                PlayClock12111WorldListOverlayState.hoveredMouseY() - 10,
                DETAIL_WIDTH,
                DETAIL_HEIGHT);
    ...
    private static void renderHeaderSummary(
        ...
        String label = PlayClock12111Localization.string(PlayClockTranslationKeys.LABEL_TOTAL_PLAYED_ON_WORLDS) + ": ";
